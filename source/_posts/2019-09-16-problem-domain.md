...
在认知心理学中 问题空间是指问题解决者对所要解决的问题的一切可能的认识状态, 包括对问题的初始状态和目标状态的认识, 以及如何从初始状态转化为目标状态的认知操作等.    问题解决就是对问题空间进行搜索, 找到一条从问题的初始状态到达目标状态的通路.   

问题的解决的思维过程可以这样去描述: 问题空间下,经过思考与推理,达到目的的心理历程.    
它分为四个阶段
* 发现问题
* 分析（明确）问题
* 提出假设
...
在这里, 会基于数学中的域理论进一步去详细描述问题解决的一般性过程作为本系列的开篇:  
